...
const UI = {
  en: {
    ...
    "stats.distribution": "Correct answers",
    "stats.local": "Kept on this device only. Nothing is uploaded.",
    "stats.empty": "Play a Daily Challenge to start building your stats.",
    "menu.best": "Best",
    "menu.streak": "Streak",
    "menu.sound": "Sound",
    "menu.muted": "Muted",
    ...
    "diff.normal": "Normal",
    "diff.hard": "Hard",
    "diff.easyNote": "Best-known countries. No lives. {n} per round.",
    "diff.normalNote": "Gets harder as you go. 3 lives, {n} per round.",
    "diff.hardNote": "Obscure countries, no hints. 3 lives, {n} per round.",
    ...
    "results.victory": "Round complete!",
    "results.endless": "Keep going ∞",
    "results.endlessSub": "No limit from here. See how far you get.",
    "results.world": "World complete!",
    "results.worldSub": "You named every one of the {n} countries this run could offer.",
  ...
  "pt-BR": {
    ...
    "stats.played": "Jogos",
    "stats.perfect": "Perfeitos",
    "stats.streak": "Sequência",
    "stats.maxStreak": "Melhor sequência",
    "stats.distribution": "Acertos por partida",
    "stats.local": "Só neste aparelho. Nada é enviado.",
    "stats.empty": "Jogue um Desafio Diário para começar suas estatísticas.",
    "menu.best": "Recorde",
    ...
    "diff.normal": "Normal",
    "diff.hard": "Difícil",
    "diff.easyNote": "Países mais conhecidos. Sem vidas. {n} por rodada.",
    "diff.normalNote": "Fica mais difícil conforme avança. 3 vidas, {n} por rodada.",
    "diff.hardNote": "Países pouco conhecidos, sem dicas. 3 vidas, {n} por rodada.",
    ...
    "results.victory": "Rodada completa!",
    "results.endless": "Continuar ∞",
    "results.endlessSub": "Sem limite a partir daqui. Veja até onde você chega.",
    "results.world": "Mundo completo!",
    "results.worldSub": "Você nomeou todos os {n} países que esta partida podia oferecer.",
